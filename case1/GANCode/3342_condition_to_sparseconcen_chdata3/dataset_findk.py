...
class TFRecordDataset:
    def __init__(self,
        ...
        tfr_realimage_files = tfr_files[:-3] #as tfrecord files include 02-06 real image files,  and one well_facies file, [:-1] ensures only reale image files are selected.
        ...
        tfr_wellfacies_file = tfr_files[-3] #as tfrecord files include 02-06 real image files, one prob_image file and one well_facies file, [-1] ensures only well facies file are selected.
        ...
        tfr_realrefers_file = tfr_files[-2] 
