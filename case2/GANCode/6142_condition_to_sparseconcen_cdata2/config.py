...
data_dir = '/public/home/yhn/back6_test10/tfdataset'  # Training data path
...
result_dir = '/public/home/yhn/back6_test10/GANresults/TrainingResults_6142_cdata2_lesswell'  # result data path
...
D3          = EasyDict(func='networks.D_paper')             # Options for discriminator network.
...
D3_loss      = EasyDict(func='loss.D3_wgangp_acgan')          # Options for discriminator loss.
...
dataset = EasyDict(tfrecord_dir= 'TrainingData_6132_cdata2_lesswell')   #Replace 'TrainingData(MultiChannels_Version4)' with parent folder name of *.tfrecords training dataset.  
